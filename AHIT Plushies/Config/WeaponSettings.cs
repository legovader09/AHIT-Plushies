...
public class WeaponSettings : BaseConfig
{
    ...
    internal sealed override void SetBindings(ConfigFile cfg)
    {
        ...
        _weaponsList["TimePieceDamage"] = Bind(cfg, "Weapon Settings", "Time Piece Damage", 2, description);
        _weaponsList["UmbrellaSpawnRate"] = Bind(cfg, "Weapon Settings", "Umbrella Spawn Rate", 15, spawnRateDesc);
        _weaponsList["BaseballBatSpawnRate"] = Bind(cfg, "Weapon Settings", "Baseball Bat Spawn Rate", 15, spawnRateDesc);
        _weaponsList["TimePieceSpawnRate"] = Bind(cfg, "Weapon Settings", "Time Piece Spawn Rate", 10, spawnRateDesc);
    }
